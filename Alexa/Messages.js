...
const NEW_ACCOUNT_MESSAGE = "Je constate que c'est votre prémières utilisation. Pas de panique je suis là pour vous guider. Pour" +
    "commencer, dites : configure ma maison. ";
...
const HELP_MESSAGE = 'Voici quellesque commandes vocales possibles: \n' +
